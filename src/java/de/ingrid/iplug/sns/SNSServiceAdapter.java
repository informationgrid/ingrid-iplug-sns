 ...
 * @author hs
 */
public class SNSServiceAdapter {
    ...
    public SNSServiceAdapter(String userName, String password, String language) throws Exception {
     ...
     * @throws Exception
     */
    public SNSServiceAdapter(String userName, String password, String language, URL url) throws Exception {
     ...
     * @throws Exception
     */
    public SNSServiceAdapter() throws Exception{
     ...
     * @param queryTerm 
     * @param path The path is used to qualify the result.
    ...
    public _topicMapFragment findTopics(String queryTerm, String path, SearchType searchType, FieldsType fieldsType, long offset) throws Exception{
        if(queryTerm == null){
     ...
     * @param analyzeMaxWords The number of words to analyze. 
     * @return
     * @throws Exception
     */
