...
//				@ComponentScan.Filter(type = FilterType.REGEX, pattern = "de.ingrid.elasticsearch.search.*"),
//				@ComponentScan.Filter(type = FilterType.REGEX, pattern = "de.ingrid.elasticsearch.ElasticsearchNodeFactoryBean"),
//				@ComponentScan.Filter(type = FilterType.REGEX, pattern = "de.ingrid.elasticsearch.IndexManager"),
//				@ComponentScan.Filter(type = FilterType.REGEX, pattern = "de.ingrid.elasticsearch.IBusIndexManager"),
//				@ComponentScan.Filter(type = FilterType.REGEX, pattern = "de.ingrid.elasticsearch.IndexInfo"),
				@ComponentScan.Filter(type = FilterType.REGEX, pattern = "de.ingrid.admin.elasticsearch.*"),
//				@ComponentScan.Filter(type = FilterType.REGEX, pattern = "de.ingrid.admin.elasticsearch.IndexRunnable"),
//				@ComponentScan.Filter(type = FilterType.REGEX, pattern = "de.ingrid.admin.elasticsearch.IndexScheduler"),
//				@ComponentScan.Filter(type = FilterType.REGEX, pattern = "de.ingrid.admin.elasticsearch.IPlugHeartbeatElasticsearch"),
...
public class SnsPlug extends HeartBeatPlug {
     ...
     */
    @Autowired
    public SnsPlug(final IMetadataInjector[] metadataInjectors,
                   Config baseConfig,
                   Configuration externalConfig,
                   final IPreProcessor[] preProcessors,
    ...
    public void configure(PlugDescription plugDescription) {
        ...
        this.fPlugId = baseConfig.communicationProxyUrl;
